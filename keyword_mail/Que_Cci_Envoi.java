...
public class Que_Cci_Envoi {
    ...
    public Que_Cci_Envoi(final String Contenu, final String Copie_cachee, final String Signature, final String Sujet) {
    ...
    public static Collection<Object[]> dataSets() {
        return asList(new Object[][]{
            {"Bonjour, ceci est un test", "marc.hage@outlook.fr", "Marc Hage Chahine", "Sujet non vide"}
        });
    }
